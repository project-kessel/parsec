...
function fetch(input)
	...
	exchangeServer := server.NewExchangeServer(trustStore, tokenService, claimsFilterRegistry, server.DefaultCredentialSources(), nil, server.DefaultRequestIDConfig())
